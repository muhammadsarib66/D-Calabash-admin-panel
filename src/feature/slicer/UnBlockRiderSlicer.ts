...
const UnBlockRiderSlicer = createSlice({
  name :"dcalabash/UnBlockRider",
  initialState,
  reducers: {
  },

  extraReducers: (builder) => {
    builder.addCase(UnBlockRiderApi.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(UnBlockRiderApi.fulfilled, (state) => {
      state.isLoading = false;
      // console.log(localStorage.getItem("token"));
    });
    builder.addCase(UnBlockRiderApi.rejected, (state) => {
      state.isLoading = false;
      state.isError = true;
    });
  },
...
export default UnBlockRiderSlicer.reducer;
