...
export const AddAdminApi: any = createAsyncThunk(
  "dcalabash/AddAdmin",
...
const AddAdminSlicer = createSlice({
  name :"AddAdmin",
  initialState,
  reducers: {
  },
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(AddAdminApi.fulfilled, (state) => {
      state.isLoading = false;
      // console.log(localStorage.getItem("token"));
    });
    builder.addCase(AddAdminApi.rejected, (state) => {
      state.isLoading = false;
      state.isError = true;
    });
  },
...
export default AddAdminSlicer.reducer;
