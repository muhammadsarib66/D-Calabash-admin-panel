...
const UpdateProductChoicesSlicer = createSlice({
  name :"updateProChoice",
  initialState,
  reducers: {
  },

  extraReducers: (builder) => {
    builder.addCase(UpdateProductChoicesApi.pending, (state) => {
      state.isLoading = true;
    });
    builder.addCase(UpdateProductChoicesApi.fulfilled, (state) => {
      state.isLoading = false;
      // console.log(localStorage.getItem("token"));
    });
    builder.addCase(UpdateProductChoicesApi.rejected, (state) => {
      state.isLoading = false;
      state.isError = true;
    });
  },
...
export default UpdateProductChoicesSlicer.reducer;
