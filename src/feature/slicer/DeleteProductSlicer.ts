...
const DeleteProductSlicer = createSlice({
  name :"dcalabash/DeleteProduct",
  initialState,
  reducers: {
  },
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(DeleteProductApi.rejected, (state) => {
      state.isLoading = false;
      state.isError = true;
    });
  },
...
export default DeleteProductSlicer.reducer;
